                ...
                <div class="card">
                    ...
                    <div class="card-body" style="display: block;">
                        ...
                        <div class="form-group">
                            ...
                            @if(Auth::user()->role == "admin")
                                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" name="id_department_position" id="position-select" data-select2-id="2" tabindex="-1" aria-hidden="true">
